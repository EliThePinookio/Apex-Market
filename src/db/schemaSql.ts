...
-- Production Migration: Tables, Indexes, Constraints, RLS, and Auth Triggers
-- ==============================================================================
...
-- 5. PRODUCTS TABLE (Inventory Catalogue)
...
-- 6. CUSTOMERS TABLE (CRM & Debt Ledger)
...
-- 7. TRANSACTIONS TABLE (Sales, Expenses, Capital, Stock Refills)
CREATE TABLE IF NOT EXISTS public.transactions (
    id TEXT PRIMARY KEY,
    business_id UUID REFERENCES public.businesses(id) ON DELETE CASCADE,
    type TEXT NOT NULL CHECK (type IN ('sale', 'expense', 'capital', 'stock_refill', 'adjustment')),
...
-- 8. STOCK MOVEMENTS TABLE (Audit Trail of Stock Quantity Adjustments)
